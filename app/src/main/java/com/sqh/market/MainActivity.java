...
import com.sqh.market.fragments.*;
...
public class MainActivity extends AppCompatActivity
    ...
    private void init() {
        ...
        rb_up = findViewById(R.id.imageButton4);
    ...
    private void setUP() {
        if (rb_up.isChecked()) {
            rb_up.setTextColor(ContextCompat.getColor(this, R.color.button_press));
        } else {
            rb_up.setTextColor(ContextCompat.getColor(this, R.color.button_normal));
        }
    }
